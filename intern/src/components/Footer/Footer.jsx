...
const Footer = () => {
  return (
    <>
    <div className="bg-neutral-950 h-100 flex flex-col items-center" id="footer">
    <h1 className="py-10 text-5xl font-bold mb-4 bg-gradient-to-r from-orange-500 to-amber-300 bg-clip-text text-transparent">
         Find Me On
        </h1>
      {/* <h5 className="text-sm font-bold text-white mb-4">Hire Me</h5> */}
    <div className="w-100 mt-6 rounded-2xl flex flex-col items-center justify-center gap-4 backdrop-blur-md shadow-[inset_0_0_20px_rgba(255,255,255,0.2),inset_0_0_5px_rgba(255,255,255,0.3),0_5px_5px_rgba(0,0,0,0.16)] transition-all duration-500 hover:bg-[rgba(173,173,173,0.05)]">

     
      <ul className="p-4 flex list-none gap-15  items-center justify-center flex-wrap flex-row">
        {/* GitHub */}
        <li className="group relative cursor-pointer transition-all duration-500">
          <span className="opacity-0 absolute h-[60px] w-[60px] rounded-full shadow-[inset_0_0_20px_rgba(255,255,255,0.3),inset_0_0_5px_rgba(255,255,255,0.5),0_5px_5px_rgba(0,0,0,0.16)] transition-all duration-300 group-hover:opacity-20"></span>
          <span className="opacity-0 absolute h-[60px] w-[60px] rounded-full shadow-[inset_0_0_20px_rgba(255,255,255,0.3),inset_0_0_5px_rgba(255,255,255,0.5),0_5px_5px_rgba(0,0,0,0.16)] transition-all duration-300 group-hover:opacity-40 group-hover:translate-x-1 group-hover:-translate-y-1"></span>
          <span className="opacity-0 absolute h-[60px] w-[60px] rounded-full shadow-[inset_0_0_20px_rgba(255,255,255,0.3),inset_0_0_5px_rgba(255,255,255,0.5),0_5px_5px_rgba(0,0,0,0.16)] transition-all duration-300 group-hover:opacity-60 group-hover:translate-x-2 group-hover:-translate-y-2"></span>
          <a href="https://github.com/Huzaifa0-2" target="_blank">
            <svg
              className="h-[60px] w-[60px] p-4 rounded-full text-[#ffae00] fill-current shadow-[inset_0_0_20px_rgba(255,255,255,0.3),inset_0_0_5px_rgba(255,255,255,0.5),0_5px_5px_rgba(0,0,0,0.16)] transition-all duration-300 group-hover:translate-x-1 group-hover:-translate-y-1"
        ...
        <li className="group relative cursor-pointer transition-all duration-500">
          ...
          <span className="opacity-0 absolute h-[60px] w-[60px] rounded-full shadow-[inset_0_0_20px_rgba(255,255,255,0.3),inset_0_0_5px_rgba(255,255,255,0.5),0_5px_5px_rgba(0,0,0,0.16)] transition-all duration-300 group-hover:opacity-40 group-hover:translate-x-1 group-hover:-translate-y-1"></span>
          <span className="opacity-0 absolute h-[60px] w-[60px] rounded-full shadow-[inset_0_0_20px_rgba(255,255,255,0.3),inset_0_0_5px_rgba(255,255,255,0.5),0_5px_5px_rgba(0,0,0,0.16)] transition-all duration-300 group-hover:opacity-60 group-hover:translate-x-2 group-hover:-translate-y-2"></span>
          <a href="https://pk.linkedin.com/in/s-m-huzaifa-riaz-23421b292?trk=people-guest_people_search-card" target="_blank">
            <svg
              className="h-[60px] w-[60px] p-4 rounded-full text-[#ffae00] fill-current shadow-[inset_0_0_20px_rgba(255,255,255,0.3),inset_0_0_5px_rgba(255,255,255,0.5),0_5px_5px_rgba(0,0,0,0.16)] transition-all duration-300 group-hover:translate-x-1 group-hover:-translate-y-1"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
...
//           <div className="w-full md:w-2/3 px-30">
...
//                     <span className="text-sm font-medium text-orange-600">{project.name}</span>
//                     <span className="text-sm font-medium text-white">{project.level}%</span>
//                   </div>
